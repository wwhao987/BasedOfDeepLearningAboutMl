...
def training():
    # 1. 数据加载
    train_dataloader, test_dataloader, test_x, test_y = fetch_dataloader(batch_size=16)
    ...
    # 命令行执行如下命令: tensorboard --logdir D:\workspaces\study\CV04\code0713\output\01\summary01
    ...
    obj = torch.load(path, map_location='cpu')  # 恢复
    print(obj)
